...
function choose_icon() {
    ...
    *)
    ...
    if [[ ${Picon} ]]; then
        ...
        ${SED} -i "" "s/VID/${Vid}/g" ${currentDir}/tmp/Icons.plist
        ${SED} -i "" "s/PID/${Pid}/g" ${currentDir}/tmp/Icons.plist
        ${SED} -i "" "s/RPX/${RP[0]}/g" ${currentDir}/tmp/Icons.plist
        ${SED} -i "" "s/RPY/${RP[1]}/g" ${currentDir}/tmp/Icons.plist
        ${SED} -i "" "s/RPW/${RP[2]}/g" ${currentDir}/tmp/Icons.plist
        ${SED} -i "" "s/RPH/${RP[3]}/g" ${currentDir}/tmp/Icons.plist
        ${SED} -i "" "s/PICON/${Picon}/g" ${currentDir}/tmp/Icons.plist
        ${SED} -i "" "s/DICON/${DICON}/g" ${currentDir}/tmp/Icons.plist
    fi
